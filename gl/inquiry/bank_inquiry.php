...
while ($myrow = db_fetch($result))
{
	...
	label_cell(get_trans_view_str($myrow["type"],$myrow["trans_no"]));
        /*Modificado por Felix Alberti 23/07/2015 para poder llamar a la vista de pago a medico con el nro de prenomina*/
        if ($myrow["type"] == ST_LIQUIDAMED)
        label_cell(get_trans_view_str($myrow["type"],$myrow["trans_no"],$myrow['ref'],false, '', '',$myrow['ref']));    
        else    
