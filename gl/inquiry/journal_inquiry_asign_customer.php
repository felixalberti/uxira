...
ref_cells(_("No Trans:"), 'no_tran', '',null, _('Enter a Number Transaction or leave empty'));
end_row();
end_table();
...
$editors = array(
	...
	ST_BANKDEPOSIT => "/gl/gl_bank_temp.php?ModifyDeposit=Yes&trans_no=%d&trans_type=%d",
//	4=> Funds Transfer,
...
$sql = get_sql_for_journal_inquiry_pend_asign(ST_BANKDEPOSIT, get_post('FromDate'),
	get_post('ToDate'), get_post('Ref'), get_post('Memo'), check_value('AlsoClosed'), get_post('no_tran'));
