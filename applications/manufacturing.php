...
class manufacturing_app extends application
{
	...
	{
		$this->application("manuf", T_gettext($this->help_context = "&Manufacturing"));

		$this->add_module(T_gettext("Transactions"));
		$this->add_lapp_function(0, T_gettext("Work &Order Entry"),
			"manufacturing/work_order_entry.php?", 'SA_WORKORDERENTRY', MENU_TRANSACTION);
		$this->add_lapp_function(0, T_gettext("&Outstanding Work Orders"),
