...
if (isset($_POST['submit']) && can_process())
{
	update_company_prefs( get_post( array( 'retained_earnings_act', 'profit_loss_year_act',
		...
		'po_over_receive' => 0.0, 'po_over_charge' => 0.0, 'default_credit_limit'=>0.0, 'ctrl_account_deb', 'ctrl_account_cred', 'item_autom_into_kit',
            'check_negative_stock'=> 0, 'authorization'=>0, 'use_tax_sales'=> 0
)));
...
$_POST['check_negative_stock'] = $myrow['check_negative_stock'];
...
$_POST['ctrl_account_deb']  = $myrow["ctrl_account_deb"];
$_POST['ctrl_account_cred']  = $myrow["ctrl_account_cred"];
$_POST['item_autom_into_kit'] = $myrow["item_autom_into_kit"];

$_POST['authorization'] = $myrow['authorization'];

$_POST['use_tax_sales'] = $myrow['use_tax_sales'];
...
check_row(_("Use Tax On Sales:"), 'use_tax_sales', null);
//---------------
...
table_section_title(_("Third receivables"));

gl_all_accounts_list_row(_("Controls Account Deb:"), 'ctrl_account_deb');
gl_all_accounts_list_row(_("Controls Account Cred:"), 'ctrl_account_cred');
//----------------
...
check_row(_("Check Negative Inventory:"), 'check_negative_stock', null);
label_row(null, _("Warning:  This may cause a delay in GL postings"), "", "class='stockmankofg' colspan=2");
text_row(_("Item autom into kit:"), 'item_autom_into_kit', $_POST['item_autom_into_kit'], 20, 60);

table_section_title(_("Patient Account"));
check_row(_("Use Patient Account Authorization:"), 'authorization', null);
