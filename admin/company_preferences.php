	...
	if ($input_error != 1)
	{
		update_company_prefs(
			get_post( array('coy_name','coy_no','gst_no','tax_prd','tax_last',
				...
				'bcc_email', 'memo_quotation', 'sales_type_without_default'))
		);
...
$_POST['memo_quotation']  = $myrow["memo_quotation"];
$_POST['sales_type_without_default']  = $myrow["sales_type_without_default"];
...
/*Begin Felix Alberti 27/05/2016*/
textarea_row(_("Comentario Presupuesto:"), 'memo_quotation', $_POST['memo_quotation'], 35, 6);
/*End Felix Alberti 27/05/2016*/
...
check_row(_("Sales Type Without Default"), 'sales_type_without_default', null);
