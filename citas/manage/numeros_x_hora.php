...
page(_("Números y Hora"), false, false, "", $js);
...
if ($Mode=='ADD_ITEM' || $Mode=='UPDATE_ITEM') 
{
  ...
  if (strlen($_POST['patron']) == 0) 
	...
	if ($input_error !=1)
	{
    	if ($selected_id != -1) 
    	{
		  update_item_numeros($selected_id, $_POST['tipo_cita'], $_POST['numero'], $_POST['hora_cita'], $_POST['clinica'],
		  $_POST['codunidfunc'],$_POST['tipo_cita']); 		
...
if ($Mode == 'Delete')
{
	...
	{*/
		delete_item_numeros($_POST['patron'], $_POST['tipo_cita'], $_POST['numero']);
...
//------------------------------------------------------------------------------------------------
if ($selec_tabla == "%") {
   $sql = "SELECT nc.patron, p.descripcion as descri_patron, nc.tipo_cita, st.descripcion, nc.numero, nc.hora_cita, nc.codunidfunc  FROM ".TB_PREF.
