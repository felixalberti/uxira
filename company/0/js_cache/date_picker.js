...
function CC() {
  ...
  var wdays = ['Do', 'Lu', 'Ma', 'Mi', 'Ju', 'Vi', 'Sa'];
  var tmonths = ['','Jan','Feb','Mar','Apr','Mayo','Jun','Jul','Aug','Sep','Oct','Nov','Dec'];
  var dateField = null;
  ...
  function calendarDrawTable() {
    ...
    table += "<tr class='header'><th colspan='8' style='padding: 3px;text-align:center;'><a href='javascript:hideCC();'>Regresar a la página anterior</a></td></tr>";
    table += "</table>";
    return table;
  }
  this.show = show;
