...
echo "<center> " . _("Category:"). " ";
echo stock_categories_list('category_id_sel', null, _("No Category Filter"), true);
echo "<br>";
echo "<hr></center>";
...
//echo stock_items_list('stock_id', $_POST['stock_id'], false, true); //felix alberti 19/07/2016
//echo stock_purchasable_items_list('stock_id', $_POST['stock_id'], false, true);
echo stock_costable_items_category_list('stock_id', $_POST['stock_id'], false, true, false, $_POST['category_id_sel']);
